...
Required secret for synthesis/training:
...
The tool-calling and OSINT-tool shards use the smarter alias; bulk JSON/Prolog/ingest/migration synthesis uses the cheap alias. Provider routing stays behind `llm.starintel.actor`.
